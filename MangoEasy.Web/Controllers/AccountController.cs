...
namespace MangoEasy.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            var code = HttpContext.Request["VerificationCode"];
            var user = _accountService.GetAccounts().FirstOrDefault(n => n.VerificationCode == code);
            if (user != null)
            {
                user.Valid = true;
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : "";
            ViewBag.HasLocalPassword = !string.IsNullOrEmpty(User.Identity.GetUserId());
